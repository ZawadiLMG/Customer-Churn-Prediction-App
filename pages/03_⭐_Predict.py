...
# create function to set up page configuration
st.set_page_config(
...
def select_model():
    ...
    with col1:
            ...
            'Logistic_Regression', 'Random_Forest'], key='selected_model')
    with col2:
        pass

    
    if st.session_state['selected_model'] == 'Logistic_Regression':
        pipeline = load_logistic_regression()
    else:
        pipeline = load_random_forest()
